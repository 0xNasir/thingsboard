...
export class AlarmFilterConfigComponent implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  formBgColor=localStorage.getItem('satlTheme')=='dark'?'#333333':'#FFFFFF';
  theme=localStorage.getItem('satlTheme');
  ...
  ngOnInit(): void {
    this.formBgColor=localStorage.getItem('satlTheme')=='dark'?'#333333':'#FFFFFF';
    if (this.data) {
