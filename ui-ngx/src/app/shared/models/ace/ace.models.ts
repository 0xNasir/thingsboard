...
function loadAceDependencies(): Observable<any> {
  if (aceDependenciesLoaded) {
    ...
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-ambiance')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-monokai')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-chaos')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-dracula')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-eclipse')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-terminal')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-tomorrow')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-tomorrow_night')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-twilight')));
    aceObservables.push(from(import('ace-builds/src-noconflict/theme-xcode')));
